...
final List<GuideSection> _accountSections = [
  ...
  GuideSection(
    title: 'Taxation Rules (Filer vs. Non-Filer)',
    icon: Icons.receipt_long_rounded,
    content: 'Your profits in mutual funds are subject to Capital Gains Tax (CGT). Being an Active Taxpayer (Filer) saves you a massive amount of money.',
    bulletPoints: [
      'Filer (On FBR ATL): Tax is generally 15% on your capital gains.',
      'Non-Filer: Tax is heavily penalized, often 30% or more on capital gains.',
      'How it is paid: You do not need to calculate or pay this manually. The AMC automatically deducts the CGT before depositing the profits into your bank account.',
